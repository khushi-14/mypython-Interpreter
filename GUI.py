...
canvas5 = tk.Canvas(root, width = 400, height = 300)
canvas5.pack()
my_text3 = tk.Text(root)
my_text3.pack(pady=20)
canvas1.create_window(250, 450, width=400, height=100, window=my_text3)
...
button2 = tk.Button(
    text="Clear", bg="#4EEE94", font=("SansSerif", 12), command = out
    )
canvas1.create_window(560, 160, width=80, height=30, window=button2)

button3 = tk.Button(
    text="Save", bg="#4EEE94", font=("SansSerif", 12), command = out
    )
canvas1.create_window(660, 160, width=80, height=30, window=button3)

button4 = tk.Button(
    text="Get User Variables", bg="#4EEE94", font=("SansSerif", 12), command = out
    )
